...
<form action="./controller?cmd=regist" method="post">
    <table align="center">
        ...
        <tr>
            <td colspan="3"><input class="textnone" type="text" name="id" id="id" placeholder="아이디" value="" onblur="return idessential(document.getElementById(id).value)"><br>
                <span id="idempty"></span><input type="hidden" name="id_check" id="id_check" value="false"></td>
            <td class="textcenter">@naver.com</td>
        </tr>
        <tr>
            <td colspan="3"><input class="textnone" type="text" name="pw" id="pw" placeholder="비밀번호" value="" onblur="return pwessential(document.getElementById(pw).value)"><br>
        ...
        <tr>
            <td colspan="4"><input class="textnone" type="text" name="name" id="name" placeholder="이름" value="" onblur="return nameessential(document.getElementById(name).value)"><br>
                <span id="nameempty"></span><input type="hidden" name="name_check" id="name_check" value="false"></td>
        </tr>
        <tr>
            <td colspan="2" class="textcenter"><label for="man">남자</label><input type="radio" name="gender" id="man" value="0"></td>
            <td colspan="2" class="textcenter"><label for="woman">여자</label><input type="radio" name="gender" id="woman" value="1"></td>
        </tr>
        <tr>
            <td class="textcenter">생일</td>
            <td><input type="text" class="textnone" name="birthyear" id="birthyear" placeholder="년(4자)" value="" onblur="return yearessential(document.getElementById(birthyear).value)"><br>
            ...
            <td width="150"><input class="textnone" type="text" name="birthday" id="birthday" placeholder="일" value="" onblur="return dayessential(document.getElementById(birthday).value)"><br>
